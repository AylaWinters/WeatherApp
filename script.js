        ...
        $.ajax({
            ...
            for (let i = 0; i < 8; i++) {
                if ((response.list[i].dt_txt).substring(11) === "12:00:00") {
                    ...
                    $("#temp2").text("Temp: " + ((response.list[i + 8].main.temp - 273.15) * 9 / 5 + 32).toFixed(0))
                    ...
                    $("#temp3").text("Temp: " + ((response.list[i + 16].main.temp - 273.15) * 9 / 5 + 32).toFixed(0))
                    ...
                    $("#temp4").text("Temp: " + ((response.list[i + 24].main.temp - 273.15) * 9 / 5 + 32).toFixed(0))
                    ...
                    $("#temp5").text("Temp: " + ((response.list[i + 32].main.temp - 273.15) * 9 / 5 + 32).toFixed(0))
